    ...
    const submitPress = () => {
      ...
      return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <TextInput style={styles.email} placeholder={'Enter Email'} onChangeText={fillEmail}></TextInput>
        <TextInput style={styles.password} placeholder={'Enter Password'} onChangeText={fillPassword}></TextInput>
